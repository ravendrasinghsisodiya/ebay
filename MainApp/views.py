...
from Ebay.settings import RAZORPAY_API_KEY,RAZORPAY_API_SECRET_KEY
import razorpay
...
def paymentSuccessPage(Request,rppid,rpoid,rpsid):
    ...
    subject = 'Order Has Been Placed : Team Ebay'
    message =   """
                Hello """+buyer.name+"""
                Your Order Has Been Placed!!!
                Now Your Track Your Order in Profile Section
        ...
        if(Request.POST.get("password")!=Request.POST.get("cpassword")):
           messages.error(Request,"Password and Confirm Password Doesn't Matched!!!")
            ...
            try:
                ...
                subject = 'Your Account Has Been Created : Team Ebay'
                message =   """
                            Hello """+b.name+"""
...
def forgetPasswordPage1(Request):
    if(Request.method=="POST"):
        ...
        try:
            ...
            subject = 'OTP for Password Reset : Team Ebay'
            message =   """
                        Hello """+user.name+"""
